    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index.php" class="logo">
                <!-- mini logo -->
                <div class="logo-mini">
                    <span class="light-logo"><img src="../../image/logo.png" width="20px" height="20px" alt="logo"></span>
                    <span class="dark-logo"><img src="../../image/logo.png" width="50px" height="50px" alt="logo">
                        Administrator</span>
                </div>
                <!-- logo-->
