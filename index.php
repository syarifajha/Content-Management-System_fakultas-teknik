...
<section id="slider" class="flexslider-wrap fullscreen clearfix">
    <div class="slider-wrapper">
        <div class="flexslider clearfix">
            <ul class="slides">
                <li class="clearfix" style="background-image: url(image/1.png); background-size: cover; background-repeat: no-repeat;">
                    <div class="overlay color"></div>
                    <div class="flex-content vertical-center">
                        <div class="container">

                            <div class="caption wow fadeInUp">
                                <h1 style="color: #ffffff; font-size: 46px;">Selamat Datang Di<br>Website Resmi Fakultas Teknik Umpo</h1>
                            </div>

                            <div class="caption wow fadeInUp">
                                <div class="button-normal white">
                                    <a href="https://pmb.umpo.ac.id">Daftar Sekarang</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <li class="clearfix" style="background-image: url(image/2.jpg); background-size: cover; background-repeat: no-repeat;">
                    <div class="overlay color"></div>
                    <div class="flex-content vertical-center">
                        <div class="container">
                            ...
                            <div class="caption wow fadeInUp">
                                <h1 style="color: #ffffff; font-size: 46px;">Universitas Muhammadiyah<br>Ponorogo </h1>
                            </div>

                            <div class="caption wow fadeInUp">
                                <div class="button-normal white">
                                    <a href="https://pmb.umpo.ac.id/v2-4-info-pendaftaran-universitas-muhammadiyah-ponorogo.html">Info Daftar</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="about-img col-md-6 wow fadeInLeft">
                    <img src="image/1.png" alt="" height="auto" width="auto" />
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="features">
                ...
                <div class="feature-item custom-food col-md-4 wow fadeInUp">
                    <div class="feature-icon">
                        <div class="icon" style="position: relative; width: 100px; height: 100px; background-color: #f9a825; border-radius: 50%; display: flex; justify-content: center; align-items: center;">
                            <!-- Center the icon within the circle -->
                            <i class="fa fa-cogs" style="font-size: 55px; color: white;"></i> <!-- Contoh ikon teknik -->
                        </div>
                    </div>
